...
## Project Structure
    ...
    ├── testapiautoconnect_107190  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_107190`
...
2. Clone this repo and `cd testapiautoconnect_107190`
